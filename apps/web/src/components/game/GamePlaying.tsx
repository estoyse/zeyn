...
import { Zap, Clock, UserCircle2 } from "lucide-react";
                ...
                {isMyTurn ? (
                  ...
                  <CardContent className="flex flex-col items-center gap-3 p-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground uppercase">Is thinking...</p>
                    </div>
                    {state.activeQuestionState && (
                      <Timer
                        expiresAt={state.activeQuestionState.timerExpiresAt}
          ...
          {state.phase === "REVEALED" && (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-2 pt-3">
                ...
                <p className="text-xs text-muted-foreground">Next question starts shortly</p>
              </div>
            </motion.div>
          )}
        </CardContent>
